...
urlpatterns = patterns("",
	...
	(r"^feedback$", "application.main.controllers.index.feedback"),
	(r"^page/(\d*)$", "application.main.controllers.index.index"),
	(r"^docs/(.*)$", "application.main.controllers.index.docs"),
	(r"^c/(.*)$", "application.main.controllers.index.catalogue"),
	(r"^folder/(.*)$", "application.main.controllers.index.catalogue"),
	(r"^document/(.*)$", "application.main.controllers.index.document"),
